...
export async function createUserHandler(req: Request<{}, {}, CreateUserInput>, res: Response) {
    ...
    try {
        ...
        if (e.code === 11000) { // i.e if uniqueness violation
...
export async function forgotPasswordHandler(req: Request<{}, {}, ForgotPasswordInput>, res: Response) {
    ...
    const message = "If a user with that email is registered, you will recieve a verifcation code via email"
...
export async function resetPasswordHandler(req: Request<ResetPasswordInput["params"], {}, ResetPasswordInput["body"]>, res: Response) {
    ...
    if (!user || !user.passwordResetCode || user.passwordResetCode !== resetPasswordCode) {
